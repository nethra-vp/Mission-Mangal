 ...
 * Duration: 14 seconds (one full cycle)
 * Extracted from scenes_C_files/interaction.c
 */

#ifndef SCENE_8_INTERACTION_H
#define SCENE_8_INTERACTION_H

#include <GL/freeglut.h>
#include <math.h>

static float s8_gTime = 0.0f;

static void s8_setColor3(float r, float g, float b) {
	glColor3f(r, g, b);
}

static void s8_drawBox(float sx, float sy, float sz) {
	glPushMatrix();
	glScalef(sx, sy, sz);
	glutSolidCube(1.0f);
	glPopMatrix();
...
static void s8_applyShinyFloorMaterial(void) {
...
static void s8_applyMatteCoatMaterial(void) {
...
static void s8_applyDefaultMaterial(void) {
...
static void s8_drawCylinder(float radius, float height, int slices) {
	int i;
...
static void s8_drawText(const char *txt, void *font) {
	int i;
	for (i = 0; txt[i] != '\0'; ++i) {
...
static void s8_drawDoor(float x, float y, float z, float w, float h, const char *label) {
	glPushMatrix();
	glTranslatef(x, y, z);

	s8_setColor3(0.88f, 0.89f, 0.9f);
	glPushMatrix();
	glTranslatef(0.0f, h * 0.5f, 0.0f);
	s8_drawBox(w, h, 0.08f);
	glPopMatrix();

	s8_setColor3(0.72f, 0.74f, 0.77f);
	glPushMatrix();
	glTranslatef(0.02f, h * 0.5f, 0.045f);
	s8_drawBox(w - 0.14f, h - 0.12f, 0.01f);
	glPopMatrix();

	s8_setColor3(0.35f, 0.37f, 0.4f);
	glPushMatrix();
	glTranslatef(w * 0.18f, h * 0.5f, 0.06f);
	s8_drawBox(0.04f, 0.16f, 0.02f);
	glPopMatrix();

	glDisable(GL_LIGHTING);
	glColor3f(0.18f, 0.2f, 0.22f);
	glRasterPos3f(-w * 0.14f, h * 0.82f, 0.065f);
	s8_drawText(label, GLUT_BITMAP_8_BY_13);
	glEnable(GL_LIGHTING);

	glPopMatrix();
}

static void s8_drawPlant(float x, float y, float z, float scale) {
	glPushMatrix();
	glTranslatef(x, y, z);
	glScalef(scale, scale, scale);

	s8_setColor3(0.24f, 0.14f, 0.08f);
	glPushMatrix();
	glTranslatef(0.0f, 0.18f, 0.0f);
	s8_drawBox(0.26f, 0.34f, 0.26f);
	glPopMatrix();

	s8_setColor3(0.28f, 0.56f, 0.22f);
	glPushMatrix();
...
static void s8_drawBlurredOfficePerson(float x, float y, float z, float tint, float height) {
	glPushMatrix();
	glTranslatef(x, y, z);

	s8_setColor3(0.55f * tint, 0.58f * tint, 0.62f * tint);
	glPushMatrix();
	glTranslatef(0.0f, height * 0.55f, 0.0f);
	s8_drawBox(0.18f, height * 0.62f, 0.14f);
	glPopMatrix();

	s8_setColor3(0.82f, 0.72f, 0.6f);
	glPushMatrix();
	glTranslatef(0.0f, height * 0.98f, 0.0f);
	glutSolidSphere(0.08f, 10, 10);
	glPopMatrix();

	s8_setColor3(0.38f * tint, 0.4f * tint, 0.43f * tint);
	glPushMatrix();
	glTranslatef(-0.06f, height * 0.15f, 0.0f);
	s8_drawBox(0.06f, height * 0.42f, 0.06f);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(0.06f, height * 0.15f, 0.0f);
	s8_drawBox(0.06f, height * 0.42f, 0.06f);
...
static void s8_drawFireExtinguisherCabinet(float x, float y, float z) {
	glPushMatrix();
	glTranslatef(x, y, z);

	s8_setColor3(0.72f, 0.08f, 0.08f);
	s8_drawBox(0.42f, 0.88f, 0.08f);

	s8_setColor3(0.92f, 0.15f, 0.12f);
	glDisable(GL_LIGHTING);
	glColor3f(0.98f, 0.98f, 0.98f);
	glRasterPos3f(-0.12f, 0.05f, 0.05f);
	s8_drawText("FIRE", GLUT_BITMAP_HELVETICA_12);
	glRasterPos3f(-0.19f, -0.14f, 0.05f);
	s8_drawText("EXTINGUISHER", GLUT_BITMAP_HELVETICA_12);
	glEnable(GL_LIGHTING);

	s8_setColor3(0.96f, 0.8f, 0.2f);
	glPushMatrix();
	glTranslatef(0.0f, 0.02f, 0.06f);
	glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
	s8_drawCylinder(0.09f, 0.42f, 18);
	glPopMatrix();

	glPopMatrix();
}

static void s8_drawHumanBase(float shirtR, float shirtG, float shirtB, float pantsR, float pantsG, float pantsB, float skinR, float skinG, float skinB) {
	s8_setColor3(shirtR, shirtG, shirtB);
	glPushMatrix();
	glTranslatef(0.0f, 1.05f, 0.0f);
	s8_drawBox(0.36f, 0.62f, 0.22f);
	glPopMatrix();

	/* Lab coat layer over formal shirt. */
	s8_applyMatteCoatMaterial();
	s8_setColor3(0.95f, 0.96f, 0.97f);
	glPushMatrix();
	glTranslatef(0.0f, 1.0f, 0.07f);
	s8_drawBox(0.4f, 0.72f, 0.06f);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(-0.14f, 1.03f, 0.03f);
	s8_drawBox(0.1f, 0.56f, 0.08f);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(0.14f, 1.03f, 0.03f);
	s8_drawBox(0.1f, 0.56f, 0.08f);
	...
	s8_drawBox(0.08f, 0.22f, 0.04f);
	glPopMatrix();
	s8_applyDefaultMaterial();

	s8_setColor3(pantsR, pantsG, pantsB);
	glPushMatrix();
	glTranslatef(-0.09f, 0.48f, 0.0f);
	s8_drawBox(0.14f, 0.52f, 0.16f);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(0.09f, 0.48f, 0.0f);
	s8_drawBox(0.14f, 0.52f, 0.16f);
	...
	s8_setColor3(skinR, skinG, skinB);
	glPushMatrix();
	glTranslatef(0.0f, 1.58f, 0.0f);
	glutSolidSphere(0.13f, 18, 18);
	glPopMatrix();

	s8_setColor3(0.16f, 0.17f, 0.18f);
	glPushMatrix();
	glTranslatef(0.0f, 1.72f, 0.0f);
	s8_drawBox(0.24f, 0.08f, 0.22f);
	glPopMatrix();
}

static void s8_drawWoman(float x, float y, float z, float walkPhase, float headingY, float nodAngle, float heightScale, float hairR, float hairG, float hairB) {
	...
	s8_drawHumanBase(0.72f, 0.84f, 0.95f, 0.82f, 0.75f, 0.55f, 0.85f, 0.67f, 0.55f);

	s8_setColor3(hairR, hairG, hairB);
	glPushMatrix();
	...
	s8_setColor3(0.92f, 0.92f, 0.93f);
	glPushMatrix();
	glTranslatef(-0.18f, 1.05f, 0.15f);
	s8_drawBox(0.18f, 0.24f, 0.03f);
	glPopMatrix();

	glPopMatrix();
}

static void s8_drawMan(float x, float y, float z, float walkPhase, float headingY, float nodAngle, float heightScale, float hairR, float hairG, float hairB) {
	...
	s8_drawHumanBase(0.95f, 0.97f, 0.98f, 0.3f, 0.32f, 0.36f, 0.86f, 0.69f, 0.55f);

	glDisable(GL_LIGHTING);
	glColor3f(0.08f, 0.18f, 0.55f);
	glRasterPos3f(-0.16f, 1.15f, 0.16f);
	s8_drawText("ISRO", GLUT_BITMAP_HELVETICA_12);
	glEnable(GL_LIGHTING);
	...
	s8_setColor3(0.22f, 0.24f, 0.28f);
	glPushMatrix();
	glTranslatef(-0.09f, 0.12f + legSwing * 0.08f, 0.0f);
	...
	s8_setColor3(0.94f, 0.82f, 0.66f);
...
static void s8_drawCorridor(void) {
	int i;

	/* Polished epoxy floor: deep charcoal/navy with strong highlights. */
	s8_applyShinyFloorMaterial();
	s8_setColor3(0.11f, 0.14f, 0.2f);
	glBegin(GL_QUADS);
	...
	s8_setColor3(0.08f, 0.22f, 0.46f);
	glBegin(GL_QUADS);
	...
	s8_setColor3(0.95f, 0.93f, 0.88f);
	glBegin(GL_QUADS);
	...
	s8_setColor3(0.72f, 0.76f, 0.82f);
	glBegin(GL_QUADS);
	...
	for (i = 0; i < 12; ++i) {
		float z = 0.5f - i * 4.2f;
		float pulse = 0.95f + 0.03f * sinf(s8_gTime * 1.2f + i * 0.35f);
		s8_setColor3(0.98f * pulse, 0.98f * pulse, 0.98f * pulse);
		glPushMatrix();
		glTranslatef(0.0f, 7.28f, z);
		s8_drawBox(8.8f, 0.08f, 0.16f);
		glPopMatrix();
	...
	/* Department doors */
	s8_drawDoor(-7.48f, 0.0f, -7.0f, 1.35f, 3.8f, "SAT INTEG");
	s8_drawDoor(-7.48f, 0.0f, -15.0f, 1.35f, 3.8f, "PROP LAB");
	s8_drawDoor(-7.48f, 0.0f, -23.0f, 1.35f, 3.8f, "MISSION CTRL");
	s8_drawDoor(-7.48f, 0.0f, -31.0f, 1.35f, 3.8f, "PAYLOAD OPS");

	/* Pulse warning beacon near Satellite Integration. */
	glPushMatrix();
	glTranslatef(-6.95f, 2.45f, -7.2f);
	s8_setColor3(0.35f, 0.04f, 0.05f);
	s8_drawBox(0.16f, 0.12f, 0.16f);
	glTranslatef(0.0f, 0.09f, 0.0f);
	s8_setColor3(0.92f, 0.07f + 0.22f * (0.5f + 0.5f * sinf(s8_gTime * 3.5f)), 0.08f);
	glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
	s8_drawCylinder(0.06f, 0.12f, 20);
	glPopMatrix();
	...
	s8_drawBox(1.05f, 0.78f, 0.05f);
	glPopMatrix();
	s8_setColor3(0.88f, 0.9f, 0.92f);
	glPushMatrix();
	glTranslatef(-7.22f, 4.86f, -12.5f);
	s8_drawBox(0.95f, 0.68f, 0.02f);
	glPopMatrix();
	glDisable(GL_LIGHTING);
	glColor3f(0.84f, 0.08f, 0.08f);
	glRasterPos3f(-7.6f, 5.05f, -12.46f);
	s8_drawText("SAFETY FIRST", GLUT_BITMAP_HELVETICA_12);
	glColor3f(0.14f, 0.2f, 0.46f);
	glRasterPos3f(-7.61f, 4.83f, -12.46f);
	s8_drawText("PPE MANDATORY", GLUT_BITMAP_HELVETICA_12);
	glEnable(GL_LIGHTING);

	s8_setColor3(0.08f, 0.12f, 0.2f);
	glPushMatrix();
	glTranslatef(-7.24f, 4.85f, -27.5f);
	s8_drawBox(1.12f, 0.82f, 0.06f);
	glPopMatrix();
	s8_setColor3(0.06f, 0.55f, 0.9f);
	glPushMatrix();
	glTranslatef(-7.22f, 4.85f, -27.5f);
	s8_drawBox(0.98f, 0.68f, 0.02f);
	glPopMatrix();
	glDisable(GL_LIGHTING);
	glColor3f(0.92f, 0.98f, 1.0f);
	glRasterPos3f(-7.58f, 4.98f, -27.46f);
	s8_drawText("SYSTEM HEALTH 97%", GLUT_BITMAP_HELVETICA_12);
	glColor3f(0.92f, 0.98f, 1.0f);
	glRasterPos3f(-7.58f, 4.78f, -27.46f);
	s8_drawText("NETWORK STABLE", GLUT_BITMAP_HELVETICA_12);
	glEnable(GL_LIGHTING);
	...
	/* Potted greenery */
	s8_drawPlant(1.8f, 0.0f, -10.0f, 1.0f);
	s8_drawPlant(2.2f, 0.0f, -25.0f, 0.92f);
	s8_drawPlant(3.0f, 0.0f, -34.0f, 0.84f);

	/* Blurred figures in glass-walled offices */
	s8_drawBlurredOfficePerson(8.8f, 0.0f, -16.0f, 0.95f, 1.55f);
	s8_drawBlurredOfficePerson(9.9f, 0.0f, -27.0f, 0.88f, 1.62f);
	s8_drawBlurredOfficePerson(10.5f, 0.0f, -37.0f, 0.8f, 1.58f);

	/* Far end wall with simplified 3D ISRO emblem. */
	s8_setColor3(0.86f, 0.9f, 0.95f);
	glBegin(GL_QUADS);
	...
	s8_setColor3(0.1f, 0.22f, 0.6f);
	glutSolidSphere(0.68f, 30, 30);
	s8_setColor3(0.98f, 0.58f, 0.12f);
	glTranslatef(0.0f, -0.1f, 0.35f);
	glRotatef(35.0f, 0.0f, 0.0f, 1.0f);
	s8_drawBox(0.14f, 1.18f, 0.08f);
	glPopMatrix();

	glDisable(GL_LIGHTING);
	glColor3f(0.08f, 0.2f, 0.52f);
	glRasterPos3f(-1.05f, 3.1f, -45.42f);
	s8_drawText("ISRO", GLUT_BITMAP_HELVETICA_18);
	glEnable(GL_LIGHTING);

	s8_drawFireExtinguisherCabinet(-7.35f, 0.88f, -20.4f);
}

static void s8_drawPeople(void) {
	float cycle = fmodf(s8_gTime, 14.0f);
	float womanX = 2.9f;
	float manX = 4.25f;
	float womanZ = -8.0f;
	float manZ = -24.0f;
	...
	s8_drawWoman(womanX, 0.0f, womanZ, s8_gTime * 4.8f * walkScale, womanHeading, nod, 1.02f, 0.19f, 0.12f, 0.1f);
	s8_drawMan(manX, 0.0f, manZ, s8_gTime * 4.5f * walkScale + 0.8f, manHeading, -nod * 0.6f, 0.96f, 0.08f, 0.07f, 0.06f);
...
static void s8_setupLights(void) {
...
static void s8_applyProjection(void) {
...
static void scene8_display(void) {
	/* Render identical to the standalone interaction.c */
	...
	s8_drawText("ISRO RESEARCH FACILITY - CORRIDOR", GLUT_BITMAP_HELVETICA_18);
	glEnable(GL_LIGHTING);

	glutSwapBuffers();
}

static void scene8_update(float deltaTime) {
	s8_gTime += deltaTime;
}

#endif /* SCENE_8_INTERACTION_H */
